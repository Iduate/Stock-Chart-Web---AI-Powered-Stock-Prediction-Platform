    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('free', 'Free User'), ('premium', 'Premium User'), ('admin', 'Admin')], default='free', max_length=10)),
                ('free_visits_remaining', models.IntegerField(default=3)),
                ('premium_subscription_date', models.DateTimeField(blank=True, null=True)),
                ...
                ('earnings_from_referrals', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_markets', models.JSONField(blank=True, default=list)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
